...
describe 'pugin/people/list/member/_member.html.haml', type: :view do
  ...
  context 'with a current MP data set' do
    ...
    before :each do
      ...
      allow(current_mp_data_set).to receive(:current_mp?).and_return(false)
      allow(current_mp_data_set).to receive(:former_mp?).and_return(true)
  ...
  context 'with a former MP data set' do
    ...
    before :each do
      ...
      allow(former_mp_data_set).to receive(:current_mp?).and_return(false)
      allow(former_mp_data_set).to receive(:former_mp?).and_return(true)
  ...
  # TODO: Currently not implemented, until requirements understood
  context 'with a parliament MP data set' do
    ...
    before :each do
      ...
      allow(parliament_mp_data_set).to receive(:current_mp?).and_return(false)
      allow(parliament_mp_data_set).to receive(:former_mp?).and_return(true)
